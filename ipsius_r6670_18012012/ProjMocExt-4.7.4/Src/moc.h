...
public:
    Moc()
        : noInclude(false), generatedCode(false), mustIncludeQMetaTypeH(false), extentionMoc(*this)
        {}
    ...
    MocExt::ExtentionMoc extentionMoc;// moc_ext: list of proxy interfaces
    void parse();
