...
typedef struct
{
    ...
    Platform::dword CRC(Platform::dword crc = Utils::RawCRC32::InitialValue) const
    {        
        crc = Utils::UpdateCRC32(&v2, 2, crc);
        crc = Utils::UpdateCRC32(&v3, 2, crc);
        crc = Utils::UpdateCRC32(&fac, 2, crc);
        crc = Utils::UpdateCRC32(&samples, sizeof(int), crc);
        crc = Utils::UpdateCRC32(&current_sample, sizeof(int), crc);
        return crc;
    }
} goertzel_state_t;
