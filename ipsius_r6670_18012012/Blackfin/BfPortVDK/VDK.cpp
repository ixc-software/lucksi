...
namespace VDK
{
	...
	{
		INIT_THREADTEMPLATE_("kMainThread",kPriority5, 2000,  ::MainThread::Create  ,ksystem_heap ,ksystem_heap,false)
	};
...
HeapID g_IOObjectHeap = ksystem_heap;
	...
	unsigned int g_ClockPeriod = 270000;
	...
	extern const unsigned int kMaxNumActiveSemaphores=128;
	VDK::IDTableElement g_SemIDElements[128 + 1];
	SemaphoreTable g_SemaphoreTable = {g_SemIDElements, 128};
