...
/*
** User heap source file generated on Jan 21, 2009 at 12:20:31.
**
...
**
** Configuration:-
**     crt_doj:                                BfPortVDK_basiccrt.doj
...
**     mem_init:                               true
**     mem_init_mem_location:                  L3
**     use_vdk:                                true
**     use_eh:                                 true
**     use_argv:                               false
**     running_from_internal_memory:           true
**     user_heap_src_file:                     D:\proj\Ipsius\Blackfin\BfPortVDK\BfPortVDK_heaptab.c
