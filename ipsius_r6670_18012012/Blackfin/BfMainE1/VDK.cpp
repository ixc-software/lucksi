...
namespace VDK
{
	...
	{
		INIT_THREADTEMPLATE_("klwip_sysboot_threadtype",kPriority5, 8000,  ::lwip_sysboot_threadtype_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kADI_TOOLS_IOEThreadType",kPriority5, 8000,  ::ADI_TOOLS_IOEThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kMainThread",kPriority10, 16000,  ::MainThread::Create  ,ksystem_heap ,ksystem_heap,false)
	};
...
HeapID g_IOObjectHeap = ksystem_heap;
	...
	extern const unsigned int kMaxNumActiveSemaphores=256;
	VDK::IDTableElement g_SemIDElements[256 + 1];
	SemaphoreTable g_SemaphoreTable = {g_SemIDElements, 256};
