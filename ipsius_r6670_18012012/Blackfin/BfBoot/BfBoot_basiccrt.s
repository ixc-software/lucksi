...
/*
** BfBoot_basiccrt.s generated on Feb 18, 2011 at 13:03:03.
**
...
.start_of_user_code_very_beginning:
  ...
  // This code is preserved if the CRT is re-generated
    ...
    */  
    ...
    /*
    состояние регистров при загрузке с JTAG
    *pEBIU_AMGCTL = 0x00ff;
    ...
    */
    ...
    P0.L = lo(PORTGIO_DIR); 			
	P0.H = hi(PORTGIO_DIR); 	
	R0 = 0x0030(Z); 			//YELLOW    /*0x0010=green 0x0020=red*/			
	W[P0] = R0;
	SSYNC;		

	P0.L = lo(PORTGIO_CLEAR); 			
	P0.H = hi(PORTGIO_CLEAR); 	//OFF
	R0 = 0x0030(Z); 			 						
	W[P0] = R0;
	SSYNC;				
